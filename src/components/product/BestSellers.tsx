    ...
    <section className="py-12 md:py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap items-center justify-between mb-8 md:mb-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-1 md:mb-2 text-gray-800">Best Sellers</h2>
            <p className="text-sm md:text-base text-gray-600">Our top selling premium products</p>
          </div>
          <Link 
            to="/products" 
